<template>
    <div class="individual-packages">
        ...
        <div class="row my-5 px-3 background-check">
                ...
                <div class="roles">
                    <carousel :perPage="1" :perPageCustom="[[767, 1], [768, 1], [1024, 3]]">
                        <slide>
                            <div class="role">
                                <div class="role-head">
                                    <h5><strong class="text-blue">Driver</strong></h5>
                                    <hr>
                                    <p><sup class="text-gray">$</sup> <span class="price text-blue">1200</span></p>
                                    <p><strong class="text-gray">Flat Rate</strong></p>
                                    <hr>
                                    <h5 class="text-gray px-3">Lorem Ipsum, or lorem ipsum as it is.</h5>
                                    <div class="row mx-5">
                                        <div class="col-12">
                                            <button class="btn btn-primary btn-block mt-3">Order Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <slide>
                            <div class="role">
                                <div class="role-head">
                                    <h5><strong class="text-blue">Domestic Help</strong></h5>
                                    <hr>
                                    <p><sup class="text-gray">$</sup> <span class="price text-blue">1200</span></p>
                                    <p><strong class="text-gray">Flat Rate</strong></p>
                                    <hr>
                        ...
                        <slide>
                            <div class="role">
                                <div class="role-head">
                                    <h5><strong class="text-blue">Security Guard</strong></h5>
                                    <hr>
                                    <p> <sup class="text-gray">$</sup><span class="price text-blue">1200</span></p>
                                    <p><strong class="text-gray">Flat Rate</strong></p>
                                    <hr>
...
export default {
    ...
    computed:{
        ...mapGetters(['individual_packages','loggedUser'])
    },
    methods:{
        getPackage(name){
...
.image {
    background: url('../assets/for_individual.jpg');
    height: 500px;
